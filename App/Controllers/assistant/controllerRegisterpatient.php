...
<?php
class controllerRegisterpatient
{
...
//test le parametre URL si il vide et accepter une seul parametre
    function __construct($url,$modelUser){
        ...
        throw new Exception('Page introuvable!');
            ...
            $this->viewRegister=new View("plateform/assistant/app/Register");

             //afficter les errors si il existe

            $this->viewRegister->generate(['errors'=>(empty($errors))?'':$errors,$type_compte=>$this->getAttArray()]);
